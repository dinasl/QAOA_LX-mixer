...
def plot_mixer_graph(LX):
    ...
    for plot_n, combination in enumerate(LX.best_combinations):
        ...
        draw_nodes(ax[plot_n], x, LX.B, LX.nL)
        ...
        ax[plot_n].legend(handles=handles, title = "Orbits", fontsize=6, title_fontsize=6, loc='upper center', bbox_to_anchor=(0.5, 1.05), frameon=False)
