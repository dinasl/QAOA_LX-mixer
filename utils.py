...
#     for orbit in orbits:
#         for node in orbit:
#             if not any(node in other_orbit for other_orbit in orbits if set(other_orbit) != set(orbit)):
#                 return False
#         # else:
#         # if not any(set(orbit).intersection(set(other_orbit)) for other_orbit in orbits if set(other_orbit) != set(orbit)):
#         #     return False
#     return True
